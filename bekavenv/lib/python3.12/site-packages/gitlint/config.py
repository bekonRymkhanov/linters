...
class LintConfig:
    ...
    def verbosity(self, value):
        ...
        if (
            self.verbosity < 0 or self.verbosity > 3
        ):  # noqa: PLR2004 (Magic value used in comparison)
            ...
            for option_name, option_value in section_dict.items():
                ...
                if qualified_section_name != "general":
                    ...
                    if self.RULE_QUALIFIER_SYMBOL in section_name:
                        qualified_section_name = self._add_named_rule(
                            config, qualified_section_name
                        )

                    config.set_rule_option(
                        qualified_section_name, option_name, option_value
                    )
